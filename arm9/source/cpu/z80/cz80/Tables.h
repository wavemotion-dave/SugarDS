...
static const byte Cycles[256] __attribute__((section(".dtcm"))) =
{
  //00 01  02  03  04  05  06  07       08  09  0A  0B   0C  0D  0E  0F
   ...
   12, 12, 16,  8, 12, 12,  8,  4,      12, 12, 16,  8,  4,  4,  8,  4,  // 0x30
...
static const byte CyclesED[256] __attribute__((section(".dtcm"))) =
{
  ...
  16, 16, 20, 20,  8, 16,  8,   12,      16, 16, 20, 20,  0, 16,  0, 12,   // 0x40
  16, 16, 20, 20,  0,  0,  8,   12,      16, 16, 20, 20,  0,  0,  8, 12,   // 0x50
  16, 16, 20, 20,  0,  0,  0,   20,      16, 16, 20, 20,  0,  0,  0, 20,   // 0x60
  12, 12, 20, 20,  0,  0,  0,   0,       16, 16, 20, 20,  0,  0,  0,  0,   // 0x70
...
static const byte CyclesXX[256] __attribute__((section(".dtcm"))) =
{
   ...
   0, 16, 24, 12,  8,  8,  12,  0,        0, 16, 16, 12, 8,  8, 12,  0,   // 0x20
