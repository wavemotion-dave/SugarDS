...
static const byte Cycles[256] __attribute__((section(".dtcm"))) =
{
  //00 01  02  03  04  05  06  07       08  09  0A  0B   0C  0D  0E  0F
   ...
   12, 12, 16,  8, 12, 12, 12,  4,      12, 12, 16,  8,  4,  4,  8,  4,  // 0x30
    ...
    8, 12, 12, 12, 12, 16,  8, 16,       8, 12, 12,  0, 12, 20,  8, 16,  // 0xC0
    8, 12, 12, 12, 12, 16,  8, 16,       8,  4, 12, 12, 12,  0,  8, 16,  // 0xD0
    8, 12, 12, 24, 12, 16,  8, 16,       8,  4, 12,  4, 12,  0,  8, 16,  // 0xE0
    8, 12, 12,  4, 12, 16,  8, 16,       8,  8, 12,  4, 12,  0,  8, 16   // 0xF0
};
